...
insert into auth.users (
  ...
  ('11111111-1111-1111-1111-111111111111', 'authenticated', 'authenticated',
   'admin@test.com', crypt('Test1234!', gen_salt('bf')), now(), now(), now()),
  ('22222222-2222-2222-2222-222222222222', 'authenticated', 'authenticated',
   'scholar@test.com', crypt('Test1234!', gen_salt('bf')), now(), now(), now()),
  ('33333333-3333-3333-3333-333333333333', 'authenticated', 'authenticated',
   'institution@test.com', crypt('Test1234!', gen_salt('bf')), now(), now(), now()),
  ('44444444-4444-4444-4444-444444444444', 'authenticated', 'authenticated',
   'user@test.com', crypt('Test1234!', gen_salt('bf')), now(), now(), now())
