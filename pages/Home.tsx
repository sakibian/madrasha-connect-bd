...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    const fetchDailyDeen = async () => {
      const data = await callEdgeFunction<{ text?: string }>('gemini-proxy', {
        action: 'daily',
        prompt: 'আজকের জন্য একটি ছোট এবং অনুপ্রেরণামূলক হাদিস বা কুরআনের আয়াত নির্বাচন করুন। শুধুমাত্র বাংলা অনুবাদ এবং রেফারেন্স প্রদান করুন।',
      });
